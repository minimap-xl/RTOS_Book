...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_15 -L processing_system7_vip_v1_0_17 -L smartconnect_v1_0 -L axi_protocol_checker_v2_0_15 -L axi_protocol_checker_v2_0_1 -L axi_vip_v1_1_1 -L processing_system7_vip_v1_0_3 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L lib_pkg_v1_0_2 -L fifo_generator_v13_2_1 -L lib_fifo_v1_0_10 -L axi_fifo_mm_s_v4_1_12 -L axi_infrastructure_v1_1_0 -L smartconnect_v1_0 -L axi_protocol_checker_v2_0_1 -L axi_vip_v1_1_1 -L processing_system7_vip_v1_0_3 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_12 -L generic_baseblocks_v2_1_0 -L axi_register_slice_v2_1_15 -L axi_data_fifo_v2_1_14 -L axi_crossbar_v2_1_16 -L util_ds_buf_v2_01_a -L xlconstant_v1_1_3 -L axis_infrastructure_v1_1_0 -L axis_data_fifo_v1_1_16 -L axis_clock_converter_v1_1_16 -L util_vector_logic_v2_0_1 -L axi_protocol_converter_v2_1_15 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot red_pitaya_ps_1 xil_defaultlib.red_pitaya_ps_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim red_pitaya_ps_1 -key {Behavioral:sim_1:Functional:red_pitaya_ps_1} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/data/Xilinx/Vivado/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb red_pitaya_ps_1.wdb xsim.dir libdpi.so)
