...
-- Command     : write_vhdl -force -mode funcsim -rename_top red_pitaya_ps_1_axis_packetizer_0_0 -prefix
--               red_pitaya_ps_1_axis_packetizer_0_0_ red_pitaya_ps_1_axis_packetizer_1_0_sim_netlist.vhdl
...
entity red_pitaya_ps_1_axis_packetizer_0_0_axis_packetizer is
  port (
...
end red_pitaya_ps_1_axis_packetizer_0_0_axis_packetizer;

architecture STRUCTURE of red_pitaya_ps_1_axis_packetizer_0_0_axis_packetizer is
  signal int_cntr_reg03_out : STD_LOGIC;
...
begin
\int_cntr_reg[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"4000FFFF"
    )
        port map (
...
\int_cntr_reg[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity red_pitaya_ps_1_axis_packetizer_0_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    cfg_data : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute NotValidForBitStream of red_pitaya_ps_1_axis_packetizer_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of red_pitaya_ps_1_axis_packetizer_0_0 : entity is "red_pitaya_ps_1_axis_packetizer_1_0,axis_packetizer,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of red_pitaya_ps_1_axis_packetizer_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of red_pitaya_ps_1_axis_packetizer_0_0 : entity is "axis_packetizer,Vivado 2017.4";
end red_pitaya_ps_1_axis_packetizer_0_0;

architecture STRUCTURE of red_pitaya_ps_1_axis_packetizer_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of m_axis_tlast : signal is "XIL_INTERFACENAME M_AXIS, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 125000000, PHASE 0.000, CLK_DOMAIN red_pitaya_ps_1_red_pitaya_ps_0_FCLK_CLK0, LAYERED_METADATA undef";
...
inst: entity work.red_pitaya_ps_1_axis_packetizer_0_0_axis_packetizer
     port map (
      aclk => aclk,
      aresetn => aresetn,
